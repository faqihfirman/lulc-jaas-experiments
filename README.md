...
**Keputusan: tidak dilakukan train/test split.**
Dataset hanya 207 sampel — memotong data untuk test set akan membuat training set terlalu kecil dan berisiko kelas minoritas (Settlement: 9 sampel) tidak terwakili cukup. Seluruh 207 sampel digunakan untuk training.

Evaluasi generalisasi dilakukan melalui **Stratified K-Fold Cross Validation** (5-fold) di notebook experiment.

> Cell untuk hard train/test split tetap disediakan di notebook dan bisa diaktifkan jika data bertambah di masa mendatang.
...
- `model.pkl` di-track git — bisa langsung digunakan tanpa re-training
